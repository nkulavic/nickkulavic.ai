          ...
          >
            ...
            <div className="mt-8">
              ...
              <p className="text-body-lg text-gray-700 leading-loose">
                I also continue to run <span className="font-semibold text-accent">MyFusion Solutions</span>, where I built MyFusion Helper — a platform with 60+ integrations connecting Infusionsoft/Keap (enterprise CRM platform) with Salesforce, Google Sheets, Twilio, and 30+ other platforms. It processes 2M+ API requests monthly and serves 2,000+ active users.
              </p>
            </div>
          </motion.div>
        </div>
          ...
          >
            ...
            <div className="overflow-x-auto pb-2">
              ...
              <img
                ...
                alt="Nick Kulavic's GitHub contribution chart showing coding activity over the past year"
      ...
      <section className="py-32 px-8 bg-gradient-to-br from-white via-cream to-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            >
              {['Senior AI Integration Engineer', 'Platform Engineer', 'Staff Full-Stack Engineer'].map((role, idx) => (
                <motion.span
                  key={role}
                  initial={{ opacity: 0, y: 10 }}
                  whileInView={{ opacity: 1, y: 0 }}
