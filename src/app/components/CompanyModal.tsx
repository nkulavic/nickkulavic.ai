...
export default function CompanyModal({ experience, isOpen, onClose }: CompanyModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent
        className="max-w-4xl max-h-[95vh] p-0 gap-0 overflow-hidden bg-white border-gray-200 rounded-3xl shadow-2xl"
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <DialogHeader className="text-left">
                <DialogTitle className="text-h3 font-bold text-gray-900 mb-2">
                  {experience.role}
                </DialogTitle>
              </DialogHeader>
