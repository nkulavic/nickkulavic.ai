...
export default function PrintResumeContent() {
  const handlePrint = () => {
    window.print();
  };
      ...
      <div className="print-resume max-w-[8.5in] mx-auto bg-white shadow-2xl">
        ...
        <div className="bg-gradient-to-br from-accent/5 to-blue-50 px-10 py-6 border-b-2 border-accent/20">
          ...
          <p className="text-sm text-gray-800 leading-relaxed font-medium">
            ...
            <strong className="text-accent"> 30+ platform integrations</strong> including Salesforce, HubSpot, Infusionsoft/Keap (enterprise CRM platform), Twilio, and project management tools.
